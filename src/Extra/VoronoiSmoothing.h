...
// Supplemented by RemovePointyFaces and LaplacianSmooth
    ...
    private:
        ...
        void FindPairPoints(size_t aCPoint1, size_t aCPoint2, std::vector<size_t> &arPIn, std::vector<size_t> &arPOut, size_t aPOutSize, size_t aPInSize,
                            const CSurfaceFace &arFace, std::vector<CPoint> &arNewPoints, std::vector<noraml_float> &arNewQuan, size_t &arIndex);
        void AddPointsAlt(std::vector<size_t> &arPVec, std::vector<CPoint> &arNewPoints, std::vector<noraml_float> &arNewQuan,
        ...
        void AddPoints(std::vector<size_t> * apPVec, std::vector<CPoint> * apNewPoints, std::vector<noraml_float> * apNewQuan,
                       size_t * apNewIndex, size_t aCPoint1, size_t aCPoint2, int aSmoothFactor); // Adds points between every pair by aSmoothFactor
        void CleanDoublePointsVorn(std::vector<CPoint>& arNewPoints, std::vector<noraml_float>& arNewQuan,
