...
namespace vivid {
    ...
    public:
        ...
        CMaterial(normal_float aOpacity, normal_float aRoughness, float aEmissionStrength, const string& arEmissionColor)
                : mOpacity(AssertNormalize(aOpacity)), mRoughness(AssertNormalize(aRoughness)), mEmissionStrength(aEmissionStrength), mEmissionColor(COLORS.at(arEmissionColor)) {}
