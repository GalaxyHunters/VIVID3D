...
# x.ExportToObjTexture(r"..\test_models\test_wrapper_win")
# y = y.ToMesh()
# y.ExportToObjTexture(r"..\test_models\test_wrapper_win")
#
# arr = [x, y]
# arr = np.array(arr)
# z = vivid.CModel(arr)
...
arrow.ExportToObj("/home/zohar/Documents/Vivid/test_models/arrow_test_py")
print "arrow done"

print "start ellips"
ellips = vivid.CreateEllipsoidMesh(20, 20, [10, 5, 5], [0, 0, 10], [-1, 2, 0], [2, 1, 0], [0, 0, 1], 0.6, 0.8, "Ellips")
ellips.ExportToObj("/home/zohar/Documents/Vivid/test_models/ellips_test_py")
print "ellips done"
# print "start animation no textures"
# vivid.RotateAnim(z, 100, 100, 1, r"..\test_models\test_wrapper_animation_win")
# print "animation with no textures done"
#
#
# print "start animation textures"
# vivid.RotateAnimTextures(z, 1000, 100, 1, r"..\test_models\test_wrapper_animation_texture_win")
# print "animation with textures done"



# print "start sphere"
# vivid.CreateSphereMesh(20, 20, 10, [0, 0, 0], 0.6, 0.8)
# print "sphere done"